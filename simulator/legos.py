...
class Legos:
    ...
    def load_lego_urdfs(self, cwd : str, blocks : List[Tuple[float, float, str]]) -> None:
        ...
        Takes in a list of x and y positions, as well as the rgba color to 
        ...
        :param blocks: a list of tuples of x, y, and rgba hex
        ...
        for b in blocks:
            ...
            b_color = [int(b[2].lstrip('#')[i:i+2], 16) / 256 for i in (0,2,4)]
